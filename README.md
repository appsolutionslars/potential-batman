...
> Date command is use toprint or  set the system date and time under Command substitution allows the output

> include today's date in shell script. You need to use command substitution in
